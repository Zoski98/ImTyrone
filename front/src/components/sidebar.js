                ...
                <ul className="navbar-nav">
                    ...
                    <li className="logos">
                        <a href="#" className="nav-link">
                            <img src={logo} alt="yo" className='side-icon' />
                        </a>

                    </li>
                    <li className="nav-item">
                        <Link className='link' to="/useres">
                            <a href="#" className="nav-link">
                    ...
                    <li className="nav-item"><Link className='link' to="/community">
                        <a href="#" className="nav-link">
                    ...
                    <li className="nav-item"><Link className='link' to="/feed">
                        <a href="#" className="nav-link">
